...
# Reading the dataset
df = pd.read_excel(r"C:\\Users\\Aiman\\OneDrive\\Documents\\GPProject-2\\Preprocess.xlsx") # Adjust the file directory 
...
if page == "🏢 Home Page":
    ...
    image = Image.open('C:\\Users\\Aiman\\OneDrive\\Documents\\GPProject-2\\Real-Estate-2.png') # Adjust the file directory  
    st.image(image)
...
# Real Estate Price Estimator Page
    ...
    with col1:
        ...
        image2 = Image.open('C:\\Users\\Aiman\\OneDrive\\Documents\\GPProject-2\\Real-Estate-3.png') # Adjust the file directory 
        st.image(image2) 
    with col2:
        ...
        image3 = Image.open('C:\\Users\\Aiman\\OneDrive\\Documents\\GPProject-2\\Real-Estate-4.png') # Adjust the file directory 
        st.image(image3)        
    with col3:
